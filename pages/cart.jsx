...
const Cart = () => {
  ...
  const createOrder = async (data) => {
    try {
      const res = await axios.post("https://restaurant-app-beta.vercel.app/api/orders", data);
      if (res.status === 201) {
        dispatch(reset());
        ...
        <div className={styles.wrapper}>
          ...
          {open ? (
            <div className={styles.paymentMethods}>
              ...
              <PayPalScriptProvider
                  options={{
                    "client-id": "AftAsGXf0ioiVC4K4Vss_ea483iP62AkfShRfdX0Zhu3_GGzKN6UyZy5dajVaaGSj3wx3fEWfyOc36fN",
                    components: "buttons",
                    currency: "USD"
                }}
              >
